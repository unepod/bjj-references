# BJJ Technique Prompts

This file contains all generated prompts for BJJ technique illustrations.

## Style Guidelines
- **Hero** (executing technique): White Gi with black belt
- **Opponent**: Blue Gi (#2772b6) with black belt
- **Skin color**: Flat (#D7A57A)
- **Background**: Light grey (#E0E0E0)
- **Style**: Thick black outlines, flat solid colors, faceless figures, bald heads
- **Composition**: Action centered, figures inside canvas
